...
export default function Navbar () {
    ...
    return (
        ...
        // should there be "whitespace" above the nav bar/header
        <div className="bg-[#6E3326] w-full h-20 bg-[radial-gradient(ellipse_25%_75%_at_top,_rgba(255,223,186,0.7)_0%,_rgba(255,165,0,0.3)_30%,_rgba(184,134,11,0.1)_70%,_rgba(110,51,38,0)_100%)]">
            <div className="flex gap-10 justify-end px-16 py-4 text-[#CC9966]">
                <Contact/>
